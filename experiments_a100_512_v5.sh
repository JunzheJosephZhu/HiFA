...
if [ $SESSION -eq 3 ]; then echo ""
    ...
    python main.py --text "<token>"  --learned_embeds_path "gt_images/fish/learned_embeds.bin" --image_path "gt_images/fish/0.png" --workspace "trials_fish_gtrate=1_v5_percep_512" --dir_text --albedo --min_percent 0.2 --sd_version 5.1 --seed 810 --dir_rate 0.5 --gt_image_rate 1 --h 256 --w 256 --denoising_steps 1 --lambda_gt 0.1 --lambda_latent 0.5
    python main.py --text "<token>"  --learned_embeds_path "gt_images/fish/learned_embeds.bin" --image_path "gt_images/fish/0.png" --workspace "trials_fish_gtrate=0.5_v5_percep_512" --dir_text --albedo --min_percent 0.2 --sd_version 5.1 --seed 810 --dir_rate 0.5 --gt_image_rate 0.5 --h 256 --w 256 --denoising_steps 1 --lambda_gt 0.1 --lambda_latent 0.5
...
if [ $SESSION -eq 1 ]; then echo ""
    python main.py --text "<token>" --learned_embeds_path "gt_images/dragon/learned_embeds.bin" --image_path "gt_images/dragon/0.png" --workspace "trials_dragon_gtrate=1_v5_percep_512" --dir_text --albedo --min_percent 0.3 --sd_version 5.1 --seed 810 --dir_rate 0.5 --gt_image_rate 1 --h 256 --w 256 --denoising_steps 1    --lambda_gt 0.1  --lambda_latent 0.5
    python main.py --text "<token>" --learned_embeds_path "gt_images/dragon/learned_embeds.bin" --image_path "gt_images/dragon/0.png" --workspace "trials_dragon_gtrate=0.5_v5_percep_512" --dir_text --albedo --min_percent 0.3 --sd_version 5.1 --seed 810 --dir_rate 0.5 --gt_image_rate 0.5 --h 256 --w 256 --denoising_steps 1    --lambda_gt 0.1  --lambda_latent 0.5

fi

if [ $SESSION -eq 2 ]; then echo ""
    python main.py --text "<token>" --learned_embeds_path "gt_images/dinosaur/learned_embeds.bin" --image_path "gt_images/dinosaur/0.png" --workspace "trials_dinosaur_gtrate=1_v5_percep_512" --dir_text --albedo --min_percent 0.3 --sd_version 5.1 --seed 810 --dir_rate 0.5 --gt_image_rate 1 --h 256 --w 256 --denoising_steps 1  --lambda_gt 0.1  --lambda_latent 0.5
    python main.py --text "<token>" --learned_embeds_path "gt_images/dinosaur/learned_embeds.bin" --image_path "gt_images/dinosaur/0.png" --workspace "trials_dinosaur_gtrate=0.5_v5_percep_512" --dir_text --albedo --min_percent 0.3 --sd_version 5.1 --seed 810 --dir_rate 0.5 --gt_image_rate 0.5 --h 256 --w 256 --denoising_steps 1  --lambda_gt 0.1  --lambda_latent 0.5
