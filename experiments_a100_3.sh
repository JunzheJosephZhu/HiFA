...
if [ $SESSION -eq 0 ]; then echo ""
    ...
    python main.py --text "<token>"  --learned_embeds_path "gt_images/fish/learned_embeds.bin" --image_path "gt_images/fish/0.png" --workspace "trials_fish_gtrate=0.5_v8" --dir_text --albedo --min_percent 0.3 --sd_version 5.1 --seed 810 --dir_rate 0.5 --gt_image_rate 0.5 --h 256 --w 256 --denoising_steps 1
