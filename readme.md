...
For both of those, need to generate some predicted views following instruction in [SyncDreamer](https://github.com/liuyuan-pal/SyncDreamer#preparation-for-training) by first removing the background and then generating 16 views. Copy over the output 0.png to this folder and specify the file with image-path.
